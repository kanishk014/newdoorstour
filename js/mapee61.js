(function ($) {
  ...
  function addMarkers(props, map) {
    $.each(props, function (i, prop) {
      ...
      var html =
        '<div class="pxp-marker-short-price">' +
        prop.price.short +
        "</div>" +
        '<a href="' +
        prop.link +
        '" class="pxp-marker-details">' +
        '<div class="pxp-marker-details-fig pxp-cover" style="background-image: url(' +
        prop.photo +
        ');"></div>' +
        '<div class="pxp-marker-details-info">' +
        '<div class="pxp-marker-details-info-title">' +
        prop.title +
        "</div>" +
        '<div class="pxp-marker-details-info-price">' +
        prop.price.long +
        "</div>" +
        '<div class="pxp-marker-details-info-feat">' +
        prop.features.beds +
        " BD<span>|</span>" +
        prop.features.baths +
        " BA<span>|</span>" +
